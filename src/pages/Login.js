...
export default function Login({ setIsLoggedIn }) {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left Panel */}
      <div className="hidden md:flex w-1/2 bg-indigo-700 text-white flex-col justify-center items-center p-12">
        ...
        <form onSubmit={handleLogin} className="w-full max-w-sm space-y-6">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-10 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
              required
            />
            <button
              type="button"
